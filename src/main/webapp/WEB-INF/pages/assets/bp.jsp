...
<head>
	...
	<!-- FONTAWESOME STYLES-->
	<spring:url value="/resources/css/font-awesome.css" var="ftCss" />
	<link href="${ftCss}" rel="stylesheet" />
	
	
     
   
     <!-- MORRIS CHART STYLES-->
     <spring:url value="/resources/js/morris/morris-0.4.3.min.css" var="ssCss" />
	<link href="${ssCss}" rel="stylesheet" />
   
        <!-- CUSTOM STYLES-->
     <spring:url value="/resources/css/custom.css" var="swCss" />
	<link href="${swCss}" rel="stylesheet" />
    
     <!-- GOOGLE FONTS-->
     <spring:url value="http://fonts.googleapis.com/css?family=Open+Sans" var="ppCss" />
	<link href="${ppCss}" rel="stylesheet"  type="text/css"/>
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Admin Dashboard</h2>   
                        <h5>Welcome 张思凯 , Love to see you back. </h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
...
<span class="label label-danger">Danger</span>
    ...
    <!-- JQUERY SCRIPTS -->
    <spring:url value="/resources/js/jquery-1.10.2.js" var="mainJs" />
    <script src="${mainJs}"></script>
      <!-- BOOTSTRAP SCRIPTS -->
     <spring:url value="/resources/js/bootstrap.min.js" var="btJs" />
    <script src="${btJs}"></script> 
    
    <!-- METISMENU SCRIPTS -->
    <spring:url value="/resources/js/jquery.metisMenu.js" var="dJs" />
    <script src="${dJs}"></script> 
    
     <!-- MORRIS CHART SCRIPTS -->
     <spring:url value="/resources/js/morris/raphael-2.1.0.min.js" var="fJs" />
     <spring:url value="/resources/js/morris/morris.js" var="mJs" />
    <script src="${fJs}"></script> 
    <script src="${mJs}"></script>
    
      <!-- CUSTOM SCRIPTS -->
      <spring:url value="/resources/js/custom.js" var="pJs" />
