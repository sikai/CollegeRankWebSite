...
font-size: 16px;"> 欢迎您！${student.lastName}${student.firstName}, 来自${student.emailAddress}  &nbsp; <a href="/webapptest/logoutSuccessful" class="btn btn-danger square-btn-adjust">Logout</a> </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a class="active-menu"><i class="fa fa-qrcode fa-3x" style="width:42px"></i> 交叉对比 </a>
                    </li>
                    <li  >
                              ...
                              <div class="tab-pane fade active in" id="home">
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel panel-default">
                                      <div class="panel-body" style=" padding: 0px;">
                                          <p style="text-align: center" style="color: gray"> <b>论文能力</b></p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="row">
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel panel-default">
                                      <div class="panel-body" style=" padding: 0px;">
                                          <p style="text-align: center" style="color: gray"> <b>分类学科</b></p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                              ...
                              -->
                               ...
                               <div class="row">
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel panel-default">
                                      <div class="panel-body" style=" padding: 0px;">
                                          <p style="text-align: center" style="color: gray"> <b>专利能力</b></p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="row">
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel panel-default">
                                      <div class="panel-body" style=" padding: 0px;">
                                          <p style="text-align: center" style="color: gray"> <b>获奖能力</b></p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="row">
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="panel panel-default">
                                      <div class="panel-body" style=" padding: 0px;">
                                          <p style="text-align: center" style="color: gray"> <b>科研成果转化能力</b></p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <hr>
                                <!--!!!!!!!!!科研基础能力-->
                                <div id="profile2" class="panel panel-default" style="margin:2px">
                                    <div class="panel-body" style="background-image: url('resources/img/star_hd.jpg'); height: 150px; background-size:cover"> 
                                      <img src="/webapptest/resources/img/s-icons_social_media_icons_white_color_transparent_background_64x64_0149_buffer.png" height="64" width="64" style="margin-left: 50%; transform: translate(-50%);">
                                      <br>
                                      <p style="text-align: center; font-size:26px; color:white">科研基础能力</p>
                                    </div>
                                </div>
                                ...
                                <hr>
                                <!--!!!!!!!!!科研投入能力-->
                                 <div id="profile1" lass="panel panel-default" style="margin:5px">
                                    <div class="panel-body" style="background-image: url('resources/img/star_hd.jpg'); height: 150px; background-size:cover"> 
                                      <img src="/webapptest/resources/img/s-icons_social_media_icons_white_color_transparent_background_64x64_0149_buffer.png" height="64" width="64" style="margin-left: 50%; transform: translate(-50%);">
                                      <br>
                                      <p style="text-align: center; font-size:26px; color:white">科研投入能力</p>
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body col-5piece">
                                        ...
                                        <div style="position: relative;top:70px">
                                            ...
                                            <hr>
                                            <span style="float: right">${college.college_title}</span>
                                            <br>
                                    ...
                                    <div class="panel-body col-5piece">
                                        ...
                                        <div style="position: relative;top:70px">
                                            ...
                                            <span style="float: right">${college.college_title}</span>
                                            <br>
                                            <span style="float: right">国家自然科学基金立项数</span>
                                        </div>
                                    ...
                                    <div class="panel-body col-5piece">
                                        ...
                                        <div style="position: relative;top:70px">
                                            ...
                                            <span style="float: right">${college.college_title}</span>
                                            <br>
                                            <span style="float: right">国家社会科学基金立项数</span>
                                        </div>
                                    ...
                                    <div class="panel-body col-5piece">
                                        ...
                                        <div style="position: relative;top:70px">
                                            ...
                                            <span style="float: right">${college.college_title}</span>
                                            <br>
                                            <span style="float: right">R&D经费总额（百万元）</span>
                                        </div>
                                    ...
                                    <div class="panel-body col-5piece">
                                        ...
                                        <div style="position: relative;top:70px">
                                            ...
                                            <span style="float: right">${college.college_title}</span>
                                            <br>
                                            <span style="float: right">人均R&D经费（千元）</span>
                                        </div>
                                    ...
                                    <div class="panel-body col-5piece">
                                        <img src="<c:url value="/resources/img/screen.png" />" style="position:absolute; right:10px;width:50px"/ >
                                        <div style="position: relative;top:70px">
                                            <p id ="projnum2" style="font-size: 50px">${talent_other.projectNum_score}</p>
                                            <hr>
                                            <span class="clg2_text" style="float: right">${college.college_title}</span>
                                            <br>
                                            <span style="float: right">2015年科研课题总数</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="panel-body col-5piece">
                                        <img src="<c:url value="/resources/img/logo11.png" />" style="position:absolute; right:10px;width:50px"/ >
                                        <div style="position: relative;top:70px">
                                            <p id ="abc2" style="font-size: 50px">${talent.nature_prize_num}</p>
                                    ...
                                    <div class="panel-body col-5piece">
                                        <img src="<c:url value="/resources/img/logo33.png" />" style="position:absolute; right:10px;width:50px"/ >
                                        <div style="position: relative;top:70px">
                                            <p id ="abc3" style="font-size: 50px">${talent.social_prize_num}</p>
                                    ...
                                    <div class="panel-body col-5piece">
                                        <img src="<c:url value="/resources/img/savings.png" />" style="position:absolute; right:10px;width:50px"/ >
                                        <div style="position: relative;top:70px">
                                            <p id ="abc4" style="font-size: 50px">${talent_other.rdMoney_score}</p>     
                                            <hr>
                                            <span class="clg2_text" style="float: right">${college.college_title}</span>
                                            <br>
                                            <span style="float: right">R&D经费总额（百万元）</span>
                                    ...
                                    <div class="panel-body col-5piece">
                                        <img src="<c:url value="/resources/img/groupcost.png" />" style="position:absolute; right:10px;width:50px"/ >
                                        <div style="position: relative;top:70px">
                                            <p id ="abc5" style="font-size: 50px">ioioioi</p>     
                                            <hr>
                                            <span class="clg2_text" style="float: right">${college.college_title}</span>
                                            <br>
                                            <span style="float: right">人均R&D经费（千元）</span>
    ...
    <script>
      ...
      $("#city1_select").change(function(){
       ...
       function updateColelge2Name(college_compare_name){
        $('.clg2_text').text(college_compare_name);
       }
       ...
       function updateDecimal(textId, num){
          var a = num.toFixed(0);
          $('#'+textId).text(a);
       }
