...
font-size: 16px;"> 欢迎您！${student.lastName}${student.firstName}, 来自${student.emailAddress}  &nbsp; <a href="/webapptest/logoutSuccessful" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        ...
        <div id="page-wrapper" >
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">${PaperPatentScore.getPaperScore()}</p>
			...
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">99</p>
                    <p class="text-muted">专利评分</p>
                </div>
             </div>
		     </div>
                    <div class="col-md-3 col-sm-6 col-xs-6">           
			<div class="panel panel-back noti-box">
                ...
                <div class="text-box" >
                    <p class="main-text">87</p>
                    <p class="text-muted">人才评分</p>
                </div>
             </div>
		     </div>
			</div>
                            ...
                            <ul class="chat-box">
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                        <img src="<c:url value="/resources/img/1.png" />" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body">                                        
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                        ...
                                        <img src="<c:url value="/resources/img/2.png" />" alt="User" class="img-circle" />
                                    </span>
                                ...
                                <li class="left clearfix">
                                    <span class="chat-img pull-left">
                                         <img src="<c:url value="/resources/img/3.png" />" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
                                ...
                                <li class="right clearfix">
                                    <span class="chat-img pull-right">
                                         <img src="<c:url value="/resources/img/4.png" />" alt="User" class="img-circle" />
                                    </span>
                                    <div class="chat-body clearfix">
